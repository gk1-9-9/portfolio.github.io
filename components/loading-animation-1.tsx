...
export function LoadingAnimationmain() {
  ...
  useEffect(() => {
    // Show name after 1.5 seconds
    const nameTimer = setTimeout(() => {
      setShowName(true)
    }, 1500)

    // Move name to top right after 3 seconds
        ...
        >
          ...
          >
            <svg viewBox="0 0 100 100" className="w-full h-full">
              {/* Clock face */}
              <circle cx="50" cy="50" r="45" fill="none" stroke="currentColor" strokeWidth="2" className="text-gold/30" />
              ...
              <motion.line
                ...
                className="text-gold"
                animate={{ rotate: 360 }}
                transition={{ duration: 60 * 5, repeat: Infinity, ease: "linear" }}
                style={{ transformOrigin: "50px 50px" }}
              />
